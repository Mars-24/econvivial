<nav class="navbar navbar-success col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="{{route('espacemembre-formation-sanitaire')}}"><img src="images/logo-brand.png" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{route('espacemembre-formation-sanitaire')}}"><img src="images/logo-brand-mini.png" alt="logo"/></a>
    </div>
