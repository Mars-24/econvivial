    ...
    <div class="container">
        <section id="services">
            ...
            <div class="section__title " data-aos="fade-down">
                <h2><i class="fas fa-users"></i>Planning Familial</h2>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="services__more" data-aos="fade-down" style="text-align: center;">
                        <a class="btn btn-primary" style="background: white; border : blue solid 1px; color: blue;" href="">Découvrez les méthodes</a>
                    </div>
                </div>
            </div>
        </section>
