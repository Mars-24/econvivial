                                                ...
                                                <div class="row">
                                                    <div id="themeBloc" class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select class="form-control" name="theme" {{old("theme")}} id="theme" required>
                                                    ...
                                                    <div id="typeBloc" class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select class="form-control" name="type" {{old("type")}} id="type" required>
                                                                    <option selected disabled>Choisir le type d'activité</option>
                                                    ...
                                                    <div id="dateActivite" class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input class="form-control" max="{{date('Y-m-d')}}" type="date" name="dtactivite" required/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <table class="table table-bordered table-condensed">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>Masculin</td>
                                                                            <td>
                                                                                <input class="form form-control" name="condomMasculin" placeholder="Nombre condom masculin"/>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Féminin</td>
                                                                            <td>
                                                                                <input class="form form-control" name="condomFeminin" placeholder="Nombre condom féminin"/>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select class="form-control" name="referer" id="referer" required>
                                                                    <option selected disabled="true">Sélectionner la réponse</option>
