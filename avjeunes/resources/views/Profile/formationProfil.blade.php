                                                                    ...
                                                                    <div class="wrapper">
                                                                        ...
                                                                        <div class="tab-content" id="myTabContent">
                                                                            <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info">
                                                                                <form action="{{route('modifierFormationSanitaireInfo')}}" method="POST">
                                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="tab-pane fade" id="avatar" role="tabpanel" aria-labelledby="avatar-tab">
                                                                                ...
                                                                                <form action="{{route('modifierUserFormationSanitaireProfile')}}" method="POST" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="tab-pane fade" id="security" role="tabpanel" aria-labelledby="security-tab">
                                                                                <form action="{{route('modifierFormationSanitairePassword')}}" method="POST">
                                                                                    <div class="form-group">
