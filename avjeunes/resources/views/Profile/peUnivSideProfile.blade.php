...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item nav-category">
            <span class="nav-link">Espace pair éducateur universitaire</span>
        </li>

        <li class="nav-item @if($page == "new-entretien") active @endif">
            <a class="nav-link" href="{{route('espace-membre-pair-educateur-universitaire')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
                <span class="menu-title">Enrégistrer un entretien</span>
            </a>
        </li>

        <li class="nav-item @if($page == "generer-rap") active @endif">
            <a class="nav-link" href="{{route('rapport-pair-educateur-universitaire')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
        ...
        <li class="nav-item @if($page == "historique-rapport") active @endif">
            <a class="nav-link" href="{{route('historique-rapport-pair-educateur-universitaire')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
