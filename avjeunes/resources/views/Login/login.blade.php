                ...
                <div class="row w-100">
                    <div class="col-lg-6 mx-auto card">
                        <div class="auth-form-light text-left p-5 card-content">
                            ...
                            <h6 class="font-weight-light" style="text-align: center;">Accéder au centre convivial dès maintenant</h6>
                                <form action="{{route('postLogin')}}" method="POST">
                                    ...
                                    @endif
                                        ...
                                        {{--<div class="row">--}}
                                            {{--<div class="col-lg-12">--}}
                                                {{--<div class="form-group" style="width: 100%;">--}}
                                                    {{--<div class="input-field col ">--}}
                                                        {{--<input type="text" style="width: 100%;" class="form-control bfh-phone" id="telephone" name="numero" value="{{ old('numero') }}"  data-country="TG" placeholder="Saisir votre numéro ou votre code d'identification" >--}}
                                                        {{--<label class="mdi mdi-calendar" for="first_name" style="font-size: 15px;" >Saisir votre numéro ou votre code d'identification</label>--}}
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group" >
                                                    <div class="input-field col ">
                                                        <input id="last_name" style="width: 100%;" required type="password" class="form-control validate" name="password">
                                    ...
                                    {{--<div class="form-group">--}}
                                        ...
                                        {{--<input type="password" class="form-control" required name="password" id="exampleInputPassword1" placeholder="Votre mot de passe">--}}
                                    ...
                                    <div class="mt-3 text-center">
                                        <a href="{{route('mot-de-passe-oublier')}}" class="auth-link text-black">Mot de passe oublié?</a>
                                    </div>
                                        <div class="mt-3 text-center">
                                        ...
                                        <div class="mt-3 text-center">
                                            <a href="{{route('activer-mon-compte')}}" class="auth-link text-black">Votre compte n'est pas actif? activez votre compte</a>
                                        </div>
                                </form>
                        </div>
                    </div>
