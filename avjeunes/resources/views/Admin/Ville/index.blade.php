                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <form class="form" action="{{route('postSaveVille')}}" method="POST">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label">Région associée</label>
                                                            <div class="col-sm-9">
                                            ...
                                            <table id="table" class="table table-bordered table-condensed table" cellspacing="0">
                                                ...
                                                @foreach($villes as $ville)
                                                    <tr class="item{{$ville->id}}">
                                                        <td>{{$ville->libelle}}</td>
                                                        <td>{{\App\Region::where("id", $ville->region_id)->first()->libelle}}</td>
                                                        <td>  <button class="btn btn-outline-info edit-modal"
                                                                      data-id = "{{$ville->id}}"
                                                                      data-libelle = "{{$ville->libelle}}"
                                                                      data-region="{{\App\Region::where("id", $ville->region_id)->first()->libelle}}">Modifier</button></td>
                                                        <td>  <button class="btn btn-outline-danger delete-modal"
                                                                      data-id = "{{$ville->id}}"
                                                                      data-libelle = "{{$ville->libelle}}">Supprimer</button></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-2" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="background-color: white;">
                ...
                <div class="modal-body">
                    <p>Voulez-vous vraiment supprimer la ville "<span><b id="ville-libelle"></b></span>" ?</p>
                </div>
                <div class="modal-footer">
