...
@section("body")
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Web série dashboard utilisateur</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <form class="form" action="{{route('post-save-web-serie')}}" enctype="multipart/form-data" method="POST">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input class="form-control" type="text" name="url" placeholder="Url de la série" required />
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="form-group">
                                                        <div class="col-sm-6" >
                                                            ...
                                                            <input type="hidden" name="userDash" value="1" />
                                            ...
                                            <table id="table" class="table table-bordered table-condensed  @if(count($series) >0 ) table-responsive @endif" cellspacing="0">
                                                <thead>
                                                <tr>
                                                    <th>Ref</th>
                                                    <th>Titre</th>
                                                ...
                                                @foreach($series as $serie)
                                                    <tr class="item{{$serie->id}}">
                                                        <td>{{$serie->id}}</td>
                                                        <td>{{$serie->titre}}</td>
                                                        <td>{{$serie->url}}</td>
                                                        <td>{{$serie->description}}</td>
                                                        <td>
                                                            <img src="images/webtv/{{$serie->image}}" alt="Aucune image" width="100" height="50">
                                                        </td>
                                                        <td>  <button class="btn btn-outline-success edit-modal"
                                                                      data-id = "{{$serie->id}}"
                                                                      data-titre = "{{$serie->titre}}"
                                                                      data-url = "{{$serie->url}}"
                                                                      data-description = "{{$serie->description}}"
                                                                      data-image = "images/webtv/{{$serie->image}}"
                                                            >Modifier</button></td>
                                                        <td>  <button class="btn btn-outline-danger delete-modal"
                                                                      data-id = "{{$serie->id}}">Supprimer</button></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
    ...
    <script>
        ...
        $(".delete-serie").on("click", function () {
            ...
            $.ajax({
                type : "POST",
                url:"{{route('post-delete-web-serie')}}",
                data:{
