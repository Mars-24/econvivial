...
@section("title")
    Enrégistrer une bannière d'agenda
@endsection
...
@section("body")
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Enrégistrer une bannière</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <form class="form" action="{{route('post-save-admin-agenda-banniere')}}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label" for="image">Image évènement (1400 x 400)</label>
                                                            <div class="col-sm-9">
                                            ...
                                            <table id="table" class="table table-bordered table-condensed" cellspacing="0">
                                                ...
                                                @foreach($agendas as $agenda)
                                                    <tr class="item{{$agenda->id}}">
                                                        <td>{{$agenda->titre}}</td>
                                                        <td><img src="public/uploads/agenda/{{$agenda->image}}" width="100" height="30"></td>
                                                        <td>  <button class="btn btn-outline-info edit-modal"
                                                                      data-id = "{{$agenda->id}}"
                                                                      data-titre = "{{$agenda->titre}}"
                                                                      data-image = "public/uploads/agenda/{{$agenda->image}}"
                                                            >Modifier</button></td>
    ...
    <div class="modal fade"  id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content" style="background-color: white;">
                <form class="form" action="{{route('post-save-edit-admin-agenda-banniere')}}" method="POST">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Modifier une bannière</h5>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-2" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="background-color: white;">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel-2">Supprimer une bannière</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script>
        ...
        $(".delete-ville").on("click", function () {
            ...
            $.ajax({
                type : "POST",
                url:"{{route('post-delete-agenda-banniere')}}",
                data:{
