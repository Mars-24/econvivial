                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">RAPPORTS D’ACTIVITES DU PRESTATAIRE  {{$user->paireducateur->code}}</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                @if(count($rapports) > 0)
                                                    ...
                                                    <button type="button" id="exportExcel" onclick="exportTableToExcel('maTable', 'Rapports d\'un PE Universitaire')" style="margin-left: 10px;margin-bottom: 20px;" class="btn btn-success">Exporter en excel</button>
                                                @endif
                                            </div>
