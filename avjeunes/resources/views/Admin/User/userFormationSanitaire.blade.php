...
@section("title")
   Gestion des utilisateurs de formations sanitaires
@endsection
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Gestions des utilisateurs de formations sanitaires</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <table id="table" class="table table-bordered table-condensed" cellspacing="0">
                                                ...
                                                @foreach($users as $user)
                                                    <tr class="item{{$user->id}}">
                                                        ...
                                                        <td>{{$user->email}}</td>
                                                        <td>{{$user->numero}}</td>
                                                        <td>{{\App\FormationSanitaire::where("id", $user->formation_sanitaire_id)->first()->libelle}}</td>
