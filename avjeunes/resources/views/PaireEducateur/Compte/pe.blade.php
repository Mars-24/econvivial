...
@section('title', 'Compte de pairs éducateurs')
...
@section('body')
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Création des pairs éducateurs</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <form class="form" action="{{route('create-pair-educateur-account')}}" method="POST" autocomplete="off">
                                                ...
                                                @foreach($universites as $universite)
                                                    <span style="display: none;" id="ecole{{$universite->id}}">{{$universite->code}}</span>
                                                @endforeach
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select class="form-control" name="ecole" id="ecole" required>
                                                                    <option selected disabled>Choisir l'Ets Scolaire</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input class="form-control" type="text" name="numero" id="numero" placeholder="N° de téléphone du PE" required />
                                                                <span class="errormsg" style="color: red;"></span>
                                                                <small class="form-text text-muted">Ex: ND123456</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-sm-3">Code PE Scolaire</label>
                                                            <div class="col-sm-9">
                                        ...
                                        <div class="row">
                                                    @if(count($users) > 0)
                                                        ...
                                                        <button type="button" id="exportExcel" onclick="exportTableToExcel('table', 'ListePairEducateur')" style="margin-left: 10px;margin-bottom: 20px;" class="btn btn-success">Exporter en excel</button>
                                            ...
                                            <table id="table" class="table table-bordered table-condensed table-striped" cellspacing="0">
                                                ...
                                                @foreach($users as $user)
                                                    <tr class="item{{$user->id}}">
                                                          <td>{{$user->paireducateur != null ? $user->paireducateur->code : "Non défini"}}</td>
    ...
    <div class="modal fade"  id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content" style="background-color: white;">
                <form class="form" action="{{route('edit-pair-educateur-account')}}" method="POST">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Modifier le compte d'un pair éducateur</h5>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-2" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="background-color: white;">
                <form action="{{route('delete-pair-educateur-account')}}" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel-2">Supprimer un pair éducateur</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <input type="hidden" id="pair-id" name="id" />
                    <input type="hidden" class="form-control" name="_token" value="{{Session::token()}}" />
    ...
    <script>
        ...
        $("#ecole").on("change", function () {
            ...
            var id = $(this).val();
            var ecoleCode = $("#ecole"+id).text();
            var region = $("#region").val();

            $("#code").val(codeReg+"-PE-"+ecoleCode);

            $.ajax({
                type : "POST",
                url:"{{route('superviseur-ecole-liste')}}",
                data:{
            ...
            $.ajax({
               ...
               data : {
                ...
                success: function (data) {
                   ...
                   $("#ecole").empty();
                   $("#edit-ecole").empty();
                    $("#ecole").append("<option selected disabled >Choisir l'Ets Scolaire</option>");
                    for(var i =0; i < data.length; i++){
