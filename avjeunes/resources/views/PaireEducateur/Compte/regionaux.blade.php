...
@section("body")
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Création des M&E régionaux</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <form class="form" action="{{route('create-encadreur-regionaux-account')}}" method="POST">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input class="form-control" type="text" name="telephone" {{old("telephone")}} id="telephone" placeholder="N° de téléphone du M&E régional" required />
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input class="form-control" type="text" name="code" style="text-transform: uppercase;" {{old("code")}} id="code" placeholder="Code M&E" required />
                                                                <span class="errormsg" style="color: red;"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    @if(count($users) > 0)
                                                        ...
                                                        <button type="button" id="exportExcel" onclick="exportTableToExcel('table', 'ListeM&ERegionaux')" style="margin-left: 10px;margin-bottom: 20px;" class="btn btn-success">Exporter en excel</button>
                                                    @endif
                                            ...
                                            <table id="table" class="table table-bordered table-condensed table-striped" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>Téléphone</th>
                                                    <th>Etat du cpte</th>
                                                    <th>Nbre M&E Ong en charge</th>
                                                    <th>Voir M&E Ong en charge</th>
													<th>Modifier</th>
                                                    <th>Supprimer</th>
                                                </tr>
                                                </thead>
    ...
    <div class="modal fade"  id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content" style="background-color: white;">
                <form class="form" action="{{route('edit-encadreur-regionaux-account')}}" method="POST">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Modifier un M&E régional</h5>
						...
						<div class="row">
							<div class="col-sm-6">
                                <div class="form-group row">
                                    <label class="col-form-label col-sm-3">Code M&E</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="code" style="text-transform: uppercase;" {{old("code")}} 
												id="edit-code" placeholder="Code M&E" required />
                                        <span class="errormsg" style="color: red;"></span>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-2" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="background-color: white;">
                <form action="{{route('delete-encadreur-regionaux-account')}}" method="POST">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel-2">Supprimer un M&E régional</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <input type="hidden" id="regionaux-id" name="id" />
                        <input type="hidden" class="form-control" name="_token" value="{{Session::token()}}" />
