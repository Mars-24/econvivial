                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Entretiens validés</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <table id="table" class="table table-bordered table-condensed table-striped table-responsive" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>Difficulté</th>
                                                    <th>Statut</th>
                                                    <th>Valider par Moi</th>
                                                    <th>Rapport Régionaux </th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                @foreach($entretiens as $entretien)
                                                    <tr class="item{{$entretien->id}}">
                                                        ...
                                                        <td> <label class="badge badge-success badge-pill">OUI</label></td>
                                                        <td><b>@if(!$entretien->regValidation)
