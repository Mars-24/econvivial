                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button type="button" id="exportExcel" onclick="exportTableToExcel('maTable', 'Détail rapport superviseur universitaire')" style="margin-left: 10px;margin-bottom: 20px;" class="btn btn-success">Exporter en excell</button>
