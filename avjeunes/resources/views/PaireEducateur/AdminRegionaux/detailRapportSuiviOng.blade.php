                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">RAPPORT  D’ACTIVITES DU M&E REGIONAL  {{$user->paireducateur->code}}</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div  class="col-sm-12" id="dataTable"  style="margin: 10px;" >
                                                ...
                                                <div class="row">
                                                    @if(count($rapports) > 0)
                                                        ...
                                                        <button type="button" id="exportExcel" onclick="exportTableToExcel('table', 'Rapports d\'un M&E ONG')" style="margin-left: 10px;margin-bottom: 20px;" class="btn btn-success">Exporter en excel</button>
                                                    @endif
                                                </div>
                                                <div id="dataTable">
                                                    <table id="table"  class="table table-bordered table-responsive" cellspacing="0">
                                                        <thead>
