...
<meta name="description" content="eCentre Convivial dispose d’une équipe de Téléconseiller composé de Médecins,
...
<div class="slider-container slider-container--hero " data-aos="fade-down" style="height: auto;">
    <div class="slider">
        <div class="slider__item">
            <img src="images/services/assistance.jpg" alt="" style="height: 350px;">
    ...
    <div class="container">
        <section id="services">
            ...
            <div class="section__title " data-aos="fade-down">
                <h2><i class="fas fa-user-md"></i>Assistance en Ligne</h2>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="services__content__desc" data-aos="fade-down">
                        <p>
                            ...
                            eCentre Convivial dispose d’une équipe de Téléconseiller composé de Médecins,
                            Gynécologues, Sages-femmes, Psychologues, Sociologues, Animateurs IEC et des Pairs
                            éducateurs qui sont à votre dispositions 24h/7j pour répondre à toutes vos préoccupations et
                            vous fournir les informations nécessaires en matière de la Santé Sexuelle et de la Reproduction.
                        ...
                        <p>
                            Quel que soit la nature de votre problème, un professionnel de la santé vous répond.
                        ...
                        <p><h3 style="text-align: center;"><b>A qui souhaiteriez-vous écrire ?</b></h3></p>

                    </div>
                </div>

            </div>
            <div class="row text-center" style="text-align: center;margin-left: 13%;margin-top: 20px;">

                <div class="col-md-2">
                    <div class="services__more" data-aos="fade-down">
                        <a class="btn btn-primary" style="background: white; border : blue solid 1px; color: blue;" href="">Médécin</a>
                    </div>
                </div>
            <div class="col-md-2">
                    <div class="services__more" data-aos="fade-down">
                        <a class="btn btn-primary" style="background: white; border : blue solid 1px; color: blue;" href="">Gynécologue</a>
                    </div>
            </div>
                <div class="col-md-2">
                    <div class="services__more" data-aos="fade-down">
                        <a class="btn btn-primary" style="background: white; border : blue solid 1px; color: blue;"  href="">Sage-femme</a>
                    </div>
            </div>
                <div class="col-md-2">
                    <div class="services__more" data-aos="fade-down">
                        <a class="btn btn-primary" style="background: white; border : blue solid 1px; color: blue;" href="">Conseiller</a>
                    </div>
            </div>
                <div class="col-md-2">
                    <div class="services__more" data-aos="fade-down">
                        <a class="btn btn-primary" style="background: white; border : blue solid 1px; color: blue;" href="">Pair éducateur</a>
                    </div>
                </div>
            </div>
        </section>
