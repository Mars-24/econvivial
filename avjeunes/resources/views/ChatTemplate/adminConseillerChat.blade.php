...
<div id="frame">
    <div id="sidepanel">
        <div id="profile">
            <div class="wrap">
                <img id="profile-img" @if($conseiller->profil == null) src="images/profil/profil.png" @else  src="images/profil/{{$conseiller->profil}}" @endif class="online" alt="" />
                <p>{{$conseiller->username}}</p>
        ...
        <div class="messages">
            <ul>
                @foreach($chats as $chat)
                    @if($chat->sender_id == $conseiller->id)
                        <li class="replies">
                            <img @if($conseiller->profil == null) src="images/profil/profil.png" @else  src="images/profil/{{$conseiller->profil}}" @endif alt="" />
...
<script >
    ...
    function loadDataForSpecifiqUser(id){
        var userID = "{{$conseiller->id}}"
        $.ajax({
            type : "POST",
            url:"{{route('retrieveChatForSpecificUserAndConseiller')}}",
            data:{
                ...
                if(data["error"] === false){
                    ...
                    for (var i=0 ; i< data["chats"].length ; i++) {
                        if(data["chats"][i].sender_id == userID){
                            $('<li class="replies"><img  @if($conseiller->profil == null) src="images/profil/profil.png" @else  src="images/profil/{{$conseiller->profil}}" @endif alt="" /><p>' + data["chats"][i].message + ' <br/> <span style="font-size: 10px;float: right;">'+data["chats"][i].created_at+'</span></p></li>').appendTo($('.messages ul'));
                        }else{
                            //alert(data["chats"][i].sender_id);
                            $('<li class="sent"><img  src="images/profil/profil.png" alt="" /><p>' + data["chats"][i].message + ' <br/> <span style="font-size: 10px;float: left;">'+data["chats"][i].created_at+'</span></p></li>').appendTo($('.messages ul'));
                        }
                    }
