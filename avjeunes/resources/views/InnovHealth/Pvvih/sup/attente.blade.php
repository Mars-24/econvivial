...
@section("title")
    Plaintes en attente de validation
@endsection
...
@section("body")
    ...
    <!-- partial -->
        ...
        @include("Profile.innovPvvihSupProfil")
        <!-- partial -->
                                                ...
                                                <table id="table" class="table table-bordered table-condensed table-striped" cellspacing="0">
                                                    ...
                                                    @foreach($pvvihs as $pvvih)
                                                        <tr class="item{{$pvvih->id}}">
                                                            ...
                                                            <td>
                                                                <form action="{{route('valider-enreg-pvvih')}}"  method="POST" >
                                                                    <input type="hidden" value="{{$pvvih->id}}" name="id" />
