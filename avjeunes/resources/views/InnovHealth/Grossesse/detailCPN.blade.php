...
@section("title")
    Calendrier des dates probables de CPN
@endsection
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-sm-8">
                                            ...
                                            <table id="table" class="table table-bordered table-condensed table-striped" cellspacing="0">
                                                ...
                                                <tr>
                                                    <td colspan="2" style="text-align: center;"><b style="font-size: 20px;">Dates probables de CPN</b></td>
                                                </tr>
                                                ...
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    @foreach($dateCPNS as $date)
                                                        <tr>
                                                            <td> <b>{{$date->cpn}}</b></td>
                                                            <td>  <b> Semaine du {{$date->dateProbable}}</b></td>
                                                        </tr>
                                                    @endforeach

                                                    <tr>
                                                        <td><b>Date Probable d'accouchement</b></td>
                                                        <td><b style="color: red;font-size: 20px;">{{$beneficiaire->dateFinSuivi}}</b></td>
                                                    </tr>
