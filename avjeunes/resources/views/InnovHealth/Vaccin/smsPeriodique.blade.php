...
@section("title")
    Rapports d'alertes SMS périodique suivi vaccination
@endsection
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Rapport périodique d'alerte SMS de suivi de vaccination</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                                    ...
                                                    <tr class="item{{$rapport->id}}">
                                                        ...
                                                        <td>
                                                            <form action="{{route('detail-rapport-suivi-grossesse')}}" method="GET">
                                                                ...
                                                                <input type="hidden" value="periodique" name="page"/>
