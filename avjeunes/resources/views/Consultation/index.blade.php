...
<div class="slider-container slider-container--hero " data-aos="fade-down" style="height: auto;">
    <div class="slider">
        <div class="slider__item">
            <img src="images/services/consultation.jpg" alt="" style="height: 350px;">
            <span class="slider__caption " data-aos="fade-right">
                <h3>Consultation IST</h3>
                </span>
        </div>
    ...
    <div class="container">
            <section id="services">
                ...
                <div class="section__title " data-aos="fade-down">
                    <h2><i class="fas fa-stethoscope"></i> Consultation IST</h2>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="services__content__desc" data-aos="fade-down">
                            <p>
                                eCentre Convivial vous offre des services adaptés en matière de la prise en
                                charge des Infections Sexuellement Transmissibles. A travers notre plateforme,
                                vous décrivez le mal dont vous souffrez et vous serez référez vers un centre
                                convivial ou une formation sanitaire la plus proche de votre situation géographique.
                                Un personnel de santé qualité sera aussitôt informé de votre arrivée et vous réservera un
                            ...
                            <p>
                                En choisissant un centre convivial ou une formation sanitaire la plus proche de
                                votre situation géographique, vous serez automatiquement informés des différentes
                                prestations des services offerts ainsi que des frais de consultation et de la disponibilité
                                des produits.
                            </p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="services__more text-center" data-aos="fade-down"  style="text-align: center;">
                            <a class="btn btn-primary " style="background: white; border : blue solid 1px; color: blue;" href="{{route('do-consultation')}}">Faire une consultation</a>
                        </div>
                    </div>
                </div>
            </section>
