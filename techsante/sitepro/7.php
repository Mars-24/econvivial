...
<head>
	...
	<title><?php echo htmlspecialchars(($seoTitle !== "") ? $seoTitle : "EXPOSITION"); ?></title>
	<base href="{{base_url}}" />
	...
	<meta name="keywords" content="<?php echo htmlspecialchars(($seoKeywords !== "") ? $seoKeywords : ""); ?>" />
		<!-- Facebook Open Graph -->
	<meta property="og:title" content="<?php echo htmlspecialchars(($seoTitle !== "") ? $seoTitle : "EXPOSITION"); ?>" />
	...
	<link href="css/7.css?ts=1580489155" rel="stylesheet" type="text/css" id="wb-page-stylesheet" />
