...
<head>
	...
	<title><?php echo htmlspecialchars(($seoTitle !== "") ? $seoTitle : "ABSTRACTS"); ?></title>
	<base href="{{base_url}}" />
	...
	<meta name="keywords" content="<?php echo htmlspecialchars(($seoKeywords !== "") ? $seoKeywords : ""); ?>" />
		<!-- Facebook Open Graph -->
	<meta property="og:title" content="<?php echo htmlspecialchars(($seoTitle !== "") ? $seoTitle : "ABSTRACTS"); ?>" />
	...
	<link href="css/6.css?ts=1580489155" rel="stylesheet" type="text/css" id="wb-page-stylesheet" />
