...
<head>
    ...
    <title> Suivi cycle menstruel </title>
...
<meta name="identifier-url" content="http://www.e-centreconvivial.org/suivi-cycle-menstruel">
...
<div class="slider-container slider-container--hero " data-aos="fade-down" style="height: auto;">
    <div class="slider">
        <div class="slider__item">
            <img src="images/services/regle.jpg" alt="" style="height: 350px;">
            <span class="slider__caption " data-aos="fade-right">
                <h3>Suivi du Cycle Menstruel</h3>
                </span>
        </div>
    ...
    <div class="container">
            <section id="services">
                ...
                <div class="section__title " data-aos="fade-down">
                    <h2><i class="fas fa-user-plus"></i>Suivi du Cycle Menstruel</h2>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="services__content__desc" data-aos="fade-down">
                            <p>
Nous assistons les femmes, surtout les jeunes filles dans la gestion de leur cycle menstruel et de l’hygiène menstruelle. En optant pour cette option, eCentre Convivial reste à votre écoute, vous assiste et vous informe des moments probable de votre menstruation et de la période d’ovulation. 
                            </p>

                            <p>
                                Vous recevrez alors périodiquement des notifications à quelques jours de votre menstruation et de votre ovulation. Retenez que ce sont des probabilités et que les données peuvent varier en fonction des changements biologiques qui pourraient intervenir dans la vie de la femme ou de la jeune fille. En cas de changement du cycle, il vous suffit régler les paramètres du Cycle menstruel.
                            </p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="services__more text-center" data-aos="fade-down"  style="text-align: center;">
                            <a class="btn btn-primary " style="background: white; border : blue solid 1px; color: blue;" href="">Suivre cycle menstruel</a>
                        </div>
                    </div>
                </div>
            </section>
