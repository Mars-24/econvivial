...
<meta name="description" content="Rester à l'écoute de tous les événements dans votre pays, en Afrique ou dans le monde en lien avec la santé sexuelle et de la reproduction ou connexe. Vous avez également la possibilité de programmer vos activités ou rendez-vous" />
...
<meta name="category" content="Agenda eCentre Convivial">
<meta name="distribution" content="global">
<meta name="identifier-url" content="http://www.e-centreconvivial.org/agenda/">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="services__more text-center" data-aos="fade-down"  style="text-align: center;">
                            <a class="btn btn-primary " style="background: white; border : blue solid 1px; color: blue;" href="">Voir l'agenda</a>
                        </div>
                    </div>
                </div>
            </section>
