                ...
                <div class="row w-100">
                    <div class="col-lg-6 mx-auto card">
                        <div class="auth-form-light text-left p-5 card-content">
                            ...
                            <h6 class="font-weight-light" style="text-align: center;">Accéder au centre eConvivial dès maintenant</h6>
                            <form action="{{route('postLogin')}}" method="POST">
                                ...
                                <!-- <div class="form-group">
                                 ...
                                 <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group" >
                                                    <div class="input-field col ">
                                                        <input id="last_name" style="width: 100%;" type="password" class="form-control validate" name="password">
                                ...
                                <div class="mt-3 text-center">
                                    <a href="{{route('inscription-agbodjandjan')}}" class="auth-link text-black">Vous n'avez pas de compte?</a>
                                </div>
                            </form>
                        </div>
                    </div>
