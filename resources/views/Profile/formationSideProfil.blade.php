...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <span class="nav-profile-image">
          ...
          <span class="login-status online"></span> <!--change to offline or busy as needed-->
            ...
            <div class="dropdown-menu navbar-dropdown" aria-labelledby="languageDropdown">
                <a class="dropdown-item" href="{{route('formation-sanitaire-profil')}}">
                    Mon compte
                </a>
        ...
        <li class="nav-item nav-category">
            <span class="nav-link">Espace formation sanitaire</span>
        </li>

        <li class="nav-item @if($page == "demande-consultation") active @endif">
            <a class="nav-link" href="{{route('espacemembre-formation-sanitaire')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
                <span class="menu-title">Demandes de consultations</span>
            </a>
        </li>

        <li class="nav-item @if($page == "consultation-effectuee") active @endif">
            <a class="nav-link" href="{{route('demande-consultation-effectuee')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
                <span class="menu-title">Consultations effectuées</span>
            </a>
        </li>

        <li class="nav-item @if($page == "consultation-resultat") active @endif">
            <a class="nav-link" href="{{route('resultat-consultation-utilisateur')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
                <span class="menu-title">Résultats envoyés</span>
            </a>
        </li>
		
        <li class="nav-item">
            <a class="nav-link" href="{{route('rapport-formation-sanitaire-consultation')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
                <span class="menu-title">Génerer un rapport</span>
            </a>
        </li>
		
        <li class="nav-item">
            <a class="nav-link" href="{{route('historique-rapport-consultation')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('facturation-des-consultation')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('historique-facturation-des-consultations')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
                <span class="menu-title">Historique des facturations</span>
            </a>
        </li>
