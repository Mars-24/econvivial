...
<nav class="sidebar sidebar-offcanvas sidebar-dark" id="sidebar" >
    <ul class="nav">
        ...
        <li class="nav-item @if($page == 'dashboard') active  @endif">
            <a class="nav-link" href="{{route('nouveau-beneficiaire-planning-familial')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
                <span class="menu-title">Nouveau Bénéficiaire</span>
            </a>
        </li>

        <li class="nav-item @if($page == 'liste-benf-migres-pf') active  @endif">
            <a class="nav-link" href="{{route('beneficiaire-migrer-pour-pf')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
                <span class="menu-title">
                    Bénéficiaires Migrés
                    <span style="border-radius: 25px;
                background: #73AD21;width: 25px;height: 25px;padding-left: 5px;padding-right: 5px;">{{$nbMigration}}</span>
                </span>
            </a>
        </li>
        ...
        <li class="nav-item @if($page == 'planning-en-cours') active @endif">
            <a class="nav-link" href="{{route('suivi-planning-familial')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
                <span class="menu-title">Suivi planning en cours</span>
            </a>
        </li>

        <li class="nav-item @if($page == 'pf-a-terme') active  @endif">
            <a class="nav-link" href="{{route('suivi-pf-a-terme')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
                <span class="menu-title">Suivi planning à terme</span>
            </a>
        </li>

        <li class="nav-item @if($page == 'flux-pf') active  @endif">
            <a class="nav-link" href="{{route('flux-pf')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
