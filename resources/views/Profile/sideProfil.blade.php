...
<nav class="sidebar sidebar-offcanvas sidebar-dark" id="sidebar"  style="min-height: calc(100vh) !important;">
    <ul class="nav" style="max-height: calc(100vh) !important;">
        ...
        <li class="nav-item" id="radio" style="cursor: pointer">

<a class="nav-link" href="https://www.webradio.media/vestaplayer/big.php?radio=eVialRadio&server=stream4.vestaradio.com&fond=431ed9&texte=ffffff&volume=50&visualizertype=0&visualizeropacity=1" target="iframe_a" >
...
<div class="modal-container" id="modal-container">
        <div class="close" id="close-radio" title="fermer radio">
            <i class="mdi mdi-close-outline menu-icon"></i>
        </div>
        <iframe id="radioIframe" name="iframe_a" src="https://www.webradio.media/vestaplayer/big.php?radio=eVialRadio&server=stream4.vestaradio.com&fond=431ed9&texte=ffffff&volume=50&visualizertype=0&visualizeropacity=1" frameBorder="0"></iframe>
</div>
<link href="{{ asset('resources/css/radio.css') }}" rel="stylesheet">
{{-- <script type="text/javascript" src="https://player.radioking.io/scripts/iframe.bundle.js"></script> --}}

 {{-- ouverture et fermeture de la modale de la radio --}}
<script>

const open_radio = document.getElementById('radio');
const  modal_radio = document.getElementById('modal-container');
const close_radio = document.getElementById('close-radio');
const iframe = document.getElementById('radioIframe');


    open_radio.addEventListener('click',()=>{
   modal_radio.classList.add('show');
    
});
    close_radio.addEventListener('click',()=>{
        iframe.src = "";
        modal_radio.classList.remove('show');
});
</script>
