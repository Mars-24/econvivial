                                                                    ...
                                                                    <div class="wrapper">
                                                                        ...
                                                                        <div class="tab-content" id="myTabContent">
                                                                            <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info">
                                                                                <form action="{{route('modifierUserInfo')}}" method="POST">
                                                                                    <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label for="designation">Sexe</label>
                                                                                        <div class="row">
                                                                                            <div class="col-sm-6">
                                                                                                <label>
                                                                                                    <input type="radio" class="form-control" @if($user->sexe == "M") checked @endif name="sexe"  value="F">M
                                                                                                </label>
                                                                                            </div>
                                                                                            <div class="col-sm-6">
                                                                                                <label>
                                                                                                    <input type="radio" class="form-control" @if($user->sexe == "F") checked @endif name="sexe"  value="F">F
                                                                                                </label>
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="date"  max="{{date('Y-m-d')}}" id="datenaissance" required class="form-control" name="datenaissance"   value="{{$user->datenaissance}}" />
                                                                                    </div>
                                                                            ...
                                                                            <div class="tab-pane fade" id="avatar" role="tabpanel" aria-labelledby="avatar-tab">
                                                                                ...
                                                                                <form action="{{route('modifierUserProfile')}}" method="POST" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="tab-pane fade" id="security" role="tabpanel" aria-labelledby="security-tab">
                                                                                <form action="{{route('modifierUserPassword')}}" method="POST">
                                                                                    <div class="form-group">
