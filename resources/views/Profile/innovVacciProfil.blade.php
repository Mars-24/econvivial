...
<nav class="sidebar sidebar-offcanvas sidebar-dark" id="sidebar" >
    <ul class="nav">
        ...
        <li class="nav-item @if($page == 'liste-benf-migres') active  @endif">
            <a class="nav-link" href="{{route('beneficiaire-migrer-pour-vaccin')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
        ...
        <li class="nav-item @if($page == 'flux-vaccin') active  @endif">
            <a class="nav-link" href="{{route('flux-vaccination')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
