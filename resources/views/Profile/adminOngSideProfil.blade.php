...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item nav-category">
            <span class="nav-link">Espace admin ong</span>
        </li>

        <li class="nav-item @if($page == "rapport") active @endif">
            <a class="nav-link" href="{{route('liste-entretien-attente-validation-admin-ong')}}">
        ...
        <li class="nav-item @if($page == "historique-rapport") active @endif">
            ...
            <a class="nav-link" href="{{route('liste-pe-univ-associe')}}">
                <i class="mdi mdi-compass-outline menu-icon"></i>
                <span class="menu-title">Suivi des Superviseurs associés</span>
            </a>
        </li>
