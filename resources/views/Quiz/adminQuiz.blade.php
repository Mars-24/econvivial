...
@section('title', 'Résultat des Quiz')
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 ">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" style="text-transform: none !important;">Résultat des Quiz</h4>
            ...
            const dt = $('#dt').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        title: 'Point obtenu',
                        render: function(data, type, row, meta) {
                            return `<label class="badge badge-primary">${data.point}</label>`
                        }
                    },
                    {
                        data: null,
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            return `
                                <form action="{{ route('detail-quiz-admin-page') }}" method="GET">
                                    <input type="hidden" name="id" value="${data.user_id}" />
                                    
                                    <input type="hidden" name="_token" value="{{ Session::token() }}" />
                                    
                                    <button type="submit" class="btn btn-success">Détails</button>
                                </form>
                            `;
                        },
                    },
