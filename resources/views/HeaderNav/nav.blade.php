    <nav class="navbar navbar-success col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="{{ route('espacemembre') }}"><img src="images/logo-brand.png"
                    alt="logo" /></a>
            <a class="navbar-brand brand-logo-mini" href="{{ route('espacemembre') }}"><img
                    src="images/logo-brand-mini.png" alt="logo" /></a>
        </div>
                ...
                <li class="nav-item dropdown" style="margin-top: 5px;">
                    ...
                    <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="#"
                        ...
                        @if (count(Auth::user()->unreadNotifications) > 0)
                            <span class="count"
                                style="margin-top: -15px;margin-left: 3px; height: 20px; width: 20px; background-color: red;border-radius: 50%;text-align: center;">
                        ...
                        @foreach (Auth::user()->unreadNotifications as $notification)
                            <a class="dropdown-item preview-item" href="#">
                                <div class="preview-thumbnail">
                                    <img src="images/profil/{{ $notification->data['receiver']['profil'] }}"
                                        class="profile-pic">
                                </div>
            ...
            <ul class="navbar-nav navbar-nav-right">
                <li class="nav-item dropdown d-none d-lg-flex">
                    <a class="nav-link dropdown-toggle" id="languageDropdown" href="#" data-toggle="dropdown">
                        ...
                        <img @if ($utilisateur->profil == null) src="images/profil/profil.png" @else  src="images/profil/{{ $utilisateur->profil }}" @endif
                            alt="user" style="height: 30px; height: 30px; border-radius: 100%;margin-left: 5px;">
                    </a>
