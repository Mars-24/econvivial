...
@section("title")
    Souscriptions au suivi de règle
@endsection
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Suivi de règle : règle prochaine dans 48 heures</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                        ...
                                        <form action="{{route('postAlertDeSuiviDeRegleDemain')}}" method="POST">
                                            <table id="table" class="table table-bordered table-condensed table" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>Date probable prochaine règle</th>
                                                    <th>Status</th>
