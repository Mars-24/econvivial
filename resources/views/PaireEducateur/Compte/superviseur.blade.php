...
@section("body")
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Création des superviseurs</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <form class="form" action="{{route('create-superviseur-account')}}" method="POST">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select class="form-control" name="ecole" {{old("ecole")}} id="ecole" required>
                                                                    <option selected disabled>Choisir l'établissement correspondante</option>
                                                                    @foreach($universites as $universite)
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-sm-3">Code Sup Ets</label>
                                                            <div class="col-sm-9">
                                                ...
                                                <div class="row">
                                                    @if(count($users) > 0)
                                                        ...
                                                        <button type="button" id="exportExcel" onclick="exportTableToExcel('table', 'ListeSuperviseurScolaire')" style="margin-left: 10px;margin-bottom: 20px;" class="btn btn-success">Exporter en excel</button>
                                                    @endif
                                                </div>
                                                <div id="dataTable">
                                                    ...
                                                    <tr class="item{{$user->id}}">
                                                        ...
                                                        <td>
                                                            <button class="btn btn-outline-success edit-modal"
																	...
																	data-universites="@json($universites)">
                                                                Modifier
                                                            </button>
                                                        </td>

                                                        <td>
                                                            <button class="btn btn-outline-danger delete-modal" data-id = "{{$user->id}}">
                                                                Supprimer
                                                            </button>
                                                        </td>
                                                    </tr>
    ...
    <script>
        ...
        $("#ecole").on("change", function () {
            ...
            $("#code").val(codeReg + "-SUP-" + ecoleCode);
        });
        ...
        $(".edit-modal").on("click", function (event) {
			...
			var universites = $(this).data('universites');
