                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Liste des M&E ONG associés</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            @endif
                                                    ...
                                                    @if(count($users) > 0)
                                                        ...
                                                        <button type="button" id="exportExcel" onclick="exportTableToExcel('table', 'Liste M&E ONG associée')" style="margin-left: 10px;margin-bottom: 20px;" class="btn btn-success">Exporter en excel</button>
                                                    @endif
                                                </div>
