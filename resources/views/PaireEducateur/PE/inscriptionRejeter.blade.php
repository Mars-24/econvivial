                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Liste des inscriptions rejetées ( <span style="color: blue;"><b>{{$ecole->libelle}}</b></span>)</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <table id="table" class="table table-bordered table-condensed table-striped table-responsive" cellspacing="0">
                                                ...
                                                @foreach($users as $user)
                                                    <tr class="item{{$user->id}}">
                                                        ...
                                                        <td>
                                                            <label class="badge badge-danger badge-pill">Rejeter</label>
                                                        </td>
                                                        <td><b>{{$user->motifRejet}}</b></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
