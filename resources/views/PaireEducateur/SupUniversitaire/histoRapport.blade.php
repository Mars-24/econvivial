                                        ...
                                        <div class="col-sm-12">
                                         ...
                                         <div class="row">
                                                    @if(count($rapports) > 0)
                                                        ...
                                                        <button type="button" id="exportExcel" onclick="exportTableToExcel('maTable', 'Historique rapport Superviseur')" style="margin-left: 10px;margin-bottom: 20px;" class="btn btn-success">Exporter en excel</button>
                                                    @endif
                                                </div>
