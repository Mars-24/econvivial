...
@section("title")
    Responsable Formation Sanitaire
@endsection
...
@section("body")
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Responsable Formation Sanitaire</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <form class="form"
                                                  action="{{route('super-admin-formation-sanitaire-save-responsable-fs')}}"
                                                  method="POST">
                                                <div class="row">
                                                    <div class="col-sm-6">
    ...
    <script>
        ...
        $("#delete-user").on("click", function () {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('postAdminFSDeleteUser')}}",
                data: {
