                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <table id="table"
                                                ...
                                                <tr>
                                                    ...
                                                    <th>PTME</th>-->
                                                    <th>Rhésus</th>
                                                    <th>Rhésus conjoint</th>
                                                    <th>CPN déjà Réalisé</th>
                                                    <th>Date Prochaine RDV</th>
                                                    <th>Âge de la Grossesse</th>
                                                    <!--<th>Nombre Echo</th>-->
                                                    <th>Statut</th>
                                                    <th>Action</th>
                                                </tr>
                                                ...
                                                @foreach($grossesses as $grossesse)
                                                    ...
                                                    <!--<td>{{\App\LanguePreference::where("beneficiaire_id",$grossesse->id)->value('libelle')}}</td>
                                                        ...
                                                        <td>{{$grossesse->reshus}}</td>
                                                        <td>{{$grossesse->conjoint_reshus}}</td>
                                                        ...
                                                        <!--<td>{{$grossesse->nbEcho}}</td>-->
                                                        <td>
                                                            @if((\App\CPN_Suivi::where("beneficiaire_id",$grossesse->id)->value('estFinis') == 1))
                                                                <label
                                                                    class="badge badge-warning badge-pill">Terminé</label>
                                                            @else
                                                        ...
                                                        <td>
                                                            ...
                                                            @if((\App\CPN_Suivi::where("beneficiaire_id",$grossesse->id)->value('estFinis') == 0))
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        <a href="{{route('detail-beneficiaire', ['ref'=>$grossesse->id,'menu'=>$menu,'page'=>$page])}}">
                                                                            <button class="btn btn-default btn-rounded btrecu dropdown-item"
                                                                                    type="button">
                                                                                <span style="color: #1a237e">Détails</span>
                                                                            </button>
                                                                        </a>
                                                                        <div><br/></div>
                                                                        <!--<button
                                                                            ...
                                                                            class="btn btn-default btn-rounded btrecu dropdown-item"
                                                                            data-id="{{$grossesse->id}}"
                                                                            data-code="{{$grossesse->code}}"
                                                                            data-num_carnet="{{$grossesse->num_carnet}}"
                                                                            data-nom="{{$grossesse->nom}}"
                                                                            data-prenom="{{$grossesse->prenom}}"
                                                                            data-date_naissance="{{$grossesse->dateNaissance}}"
                                                                            data-telephone="{{$grossesse->telephone}}"
                                                                            data-quartier="{{\App\Quartier::where("id", $grossesse->quartier_id)->first()->id}}"
                                                                            data-langue="{{$grossesse->langue}}"
                                                                            data-have_conjoint="{{$grossesse->haveConjoint}}"
                                                                            data-telephone_conjoint="{{$grossesse->telephoneConjoint}}"
                                                                            data-nom_conjoint="{{\App\Conjoint::where("beneficiaire_id",$grossesse->id)->value('nom')}}"
                                                                            data-prenom_conjoint="{{\App\Conjoint::where("beneficiaire_id",$grossesse->id)->value('prenom')}}"
                                                                            data-rhesus="{{$grossesse->reshus}}"
                                                                            data-rhesus_conjoint="{{$grossesse->conjoint_reshus}}"
                                                                            data-ptme="{{$grossesse->ptme}}"
                                                                            data-date_regle="{{$grossesse->dateRegle}}"
                                                                            data-duree_grossesse="{{$grossesse->dureeGrossese}}"
                                                                            data-date_prochainecpn="{{date_format(date_create(\App\CPN_Suivi::where("beneficiaire_id",$grossesse->id)->value('dateProchaineCPN')),"d/m/yyyy")}}"
                                                                            data-nb_echo="{{$grossesse->nbEcho}}"
                                                                            data-nb_cpn="{{\App\CPN_Suivi::where("beneficiaire_id",$grossesse->id)->value('nb_cpn')}}">
                                                                            <span
                                                                                style="color: seagreen">Modifier</span>
                                                                        </button>
                                                                        <div><br/></div>-->
                                                                        <button
                                                                            type="button" id="btrecu"
                                                                            ...
                                                                            <span style="color: deepskyblue">Reçu</span>
                                                                        </button>
                                                                        <div><br/></div>
                                                                        <button
                                                                            type="button" id="btrecu"
                                                                            data-toggle="modal"
                                                                            data-target="#terminerCpn"
                                                                            class="btn btn-default btn-rounded btrecu dropdown-item"
                                                                            data-id="{{$grossesse->id}}"
                                                                            data-code="{{$grossesse->code}}"
                                                                            data-num_carnet="{{$grossesse->num_carnet}}"
                                                                            ...
                                                                            data-rhesus_conjoint="{{$grossesse->conjoint_reshus}}">
                                                                            <span
                                                                                style="color: coral">Terminer CPN</span>
                                                                        </button>
                                                                        <div><br/></div>
                                                                        <button
                                                                            type="button" id="btrecu"
                                                                            data-toggle="modal"
                                                                            data-target="#transfertModal"
                                                                            class="btn btn-default btn-rounded btrecu dropdown-item"
                                                                            data-id="{{$grossesse->id}}"
                                                                            data-nom="{{$grossesse->nom}}"
                                                                            data-prenom="{{$grossesse->prenom}}"
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        <!--<button
                                                                            ...
                                                                            data-date_prochainecpn="{{date_format(date_create(\App\CPN_Suivi::where("beneficiaire_id",$grossesse->id)->value('dateProchaineCPN')),"d/m/yyyy")}}"
                                                                            data-nb_echo="{{$grossesse->nbEcho}}"
                                                                            data-nb_cpn="{{\App\CPN_Suivi::where("beneficiaire_id",$grossesse->id)->value('nb_cpn')}}" disabled>
                                                                            <span
                                                                                style="color: seagreen">Modifier</span>
                                                                        </button>-->
                                                                        <div><br/></div>
                                                                        <button
                                                                            ...
                                                                            data-code="{{$grossesse->code}}"
                                                                            data-num_carnet="{{$grossesse->num_carnet}}"
                                                                            data-dateFinSuivi="{{date_format(date_create($grossesse->dateFinSuivi),"d M Y")}}" disabled>
                                                                            <span style="color: deepskyblue">Reçu</span>
                                                                        </button>
                                                                        <div><br/></div>
                                                                        <button
                                                                            ...
                                                                            data-num_carnet="{{$grossesse->num_carnet}}"
                                                                            data-rhesus="{{$grossesse->reshus}}"
                                                                            data-rhesus_conjoint="{{$grossesse->conjoint_reshus}}" disabled>
                                                                            <span
                                                                                style="color: coral">Terminer CPN</span>
                                                                        </button>
                                                                        <div><br/></div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{route("beneficiaire-recu")}}" method="POST">
                                ...
                                <div class="row" style="margin: 20px">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group row" style="margin-top: 10px;">
                                            <label class="col-sm-3">Num&eacute;ro Carnet</label>
                                            <div class="col-sm-9">
                                ...
                                <div class="row" style="margin: 20px">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group row" style="margin-top: 10px;">
                                            <label class="col-sm-3">Rhesus conjoint</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group row" style="margin-top: 10px;">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="number"
                                                       name="poids" id="poids" step="0.01"
                                                       placeholder="Le poids de ce jour"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="row" style="margin: 20px">
                                    <div class="col-sm-6">
                                        <div class="form-group row" style="margin-top: 10px;">
                                            <label class="control-label col-sm-3">
                                                Nombre d'écho réalisé
                                            </label>
                                            <div class="col-sm-9">
                                                <select class="form-control" name="nb_echo"
                                                        required>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group row" style="margin-top: 10px;">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text"
                                                       name="facteur" id="facteur"
                                                       placeholder="Saisir le facteur de risque"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group row" style="margin-top: 10px;">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text"
                                                       ...
                                                       placeholder="Saisir l'examen complémentaires"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group row" style="margin-top: 10px;">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text"
                                                       ...
                                                       placeholder="Saisir la Décision/Traitement"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group row" style="margin-top: 10px;">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="date" min="{{date('Y-m-d')}}"
                                                       ...
                                                       placeholder="Date prochaine rendez-vous"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
