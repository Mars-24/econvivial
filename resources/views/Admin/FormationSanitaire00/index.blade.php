                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <form class="form" action="{{route('postFormationSanitaire')}}" method="POST">
                                <div class="row">
                                        <div class="col-sm-6">
                                      <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">Nom de la formation sanitaire</label>
                                            <div class="col-sm-9">
                                              <input class="form-control" type="text" name="formation" placeholder="Le nom  de la formation sanitaire" required />
                                          </div>
                                      </div>
                                        </div>
                                      ...
                                      <div class="col-sm-6">
                                        <div class="form-group row">
                                            <label class="control-label col-sm-3">Ville de la formation sanitaire</label>
                                            <div class="col-sm-9">
                                                <select class="form-control" name="ville" required>
                                                    <option selected disabled>Choisir la ville correspondante</option>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" name="situationGeo" placeholder="Situation géographique de la formation sanitaire" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" name="telephone" id="telephone" placeholder="N° de téléphone du centre" required />
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Frais consultation</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" id="frais" name="frais" placeholder="Frais de consultation" required />
                                                    <span class="msgFrais" style="color: red;"></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" name="pointFocal" placeholder="Nom du point focal des prestataires" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Contact du point focal des prestataires </label>
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" id="contact" name="contact" placeholder="Contact du point focal des prestataires" required />
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                            <textarea class="form-control" name="service" id="service" rows="3" placeholder="Services offerts par la formation sanitaire"></textarea>
                                                    </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" id="lienLocalisation" name="lienLocalisation" placeholder="Renseigner le lien de localisation" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="item{{$formation->id}}">
                                        ...
                                        <td>  <button class="btn btn-outline-info edit-modal"
                                            ...
                                            data-ville ="{{\App\Ville::where("id", $formation->ville_id)->first()->libelle}}">Modifier</button></td>
                                        <td>  <button class="btn btn-outline-danger delete-modal"
                                            data-id = "{{$formation->id}}">Supprimer</button></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
...
<div class="modal fade"  id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content" style="background-color: white;">
            <form class="form" action="{{route('postEditFormationSanitaire')}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Situation géographique</label>
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" id="edit-situation" name="situationGeo" placeholder="Situation géographique de la formation sanitaire" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label class="control-label col-sm-3">N° Téléphone</label>
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="telephone" id="edit-telephone" placeholder="N° de téléphone du centre" required />
                                    <span class="errormsg" style="color: red;"></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Frais consultation</label>
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" id="edit-frais" name="frais" placeholder="Frais de consultation" required />
                                    <span class="msgFrais" style="color: red;"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label class="control-label col-sm-3">Nom du point focal des prestataires</label>
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" id="edit-point" name="pointFocal" placeholder="Nom du point focal des prestataires" required />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Contact du point focal des prestataires </label>
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" id="edit-contact" name="contact" placeholder="Contact du point focal des prestataires" required />
                                    <span class="msgContact" style="color: red;"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label class="control-label col-sm-3">Services offerts</label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="service" id="edit-service" rows="3" placeholder="Services offerts par la formation sanitaire"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Lien de locatisation </label>
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" id="edit-lienLocalisation" name="lienLocalisation" placeholder="Renseigner le lien de localisation" required />
                                </div>
                            </div>
                        </div>
                    </div>
