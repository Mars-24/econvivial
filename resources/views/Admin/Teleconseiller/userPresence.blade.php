  ...
  <header class="header" data-header>
   ...
   <main>
    <article class="container article">
      ...
      <p class="article-subtitle">Fiche de presence du {{$presences[0]->nom. " ".$presences[0]->prenom }} @if($debut != null && $fin != null)  du {{date_format(date_create($debut),"d M Y")}} au {{date_format(date_create($fin),"d M Y")}} @endif </p>
        ...
        <div class="card profile-card">
          ...
          <div class="profile-card-wrapper">
            ...
            <div>
              ...
              <p class="card-subtitle" >Fonction: {{$presences[0]->fonction }} </p>
...
<!-- 
        ...
        <div class="card-wrapper">
          ...
          <div class="card task-card">
            ...
            <div>
              <data class="card-data" value="21">4</data>
                                ...
                                <tr class="item{{$presence->id }}">
                                    ...
                                    <td>
                                        <form action="{{ route('detail-presence-tele-conseiller') }}" method="GET">
                                            ...
                                            <button style="background-color: hsl(318, 99%, 70%); padding : 2px ; border-radius: 18px; color: #ffffff; text-align: center;" type="submit" class="btn btn-outline-success">Visualiser le rapport</button>
                                        </form>
                                    </td>
                                </tr>
                                @endforeach
