...
<!-- 
        ...
        <div class="card-wrapper">
          ...
          <div class="card task-card">
            ...
            <div>
              <data class="card-data" value="21">2</data>
...
<!-- 
			...
			<div class="table-data">
				<div class="order">
					<div class="head">
						<h3>Table des listes Téléconseiller</h3>
						<i class='bx bx-search' ></i>
                            ...
                            @foreach($conseillers as $conseiller)
                                <tr class="item{{$conseiller->id}}">
                                    ...
                                    <td>
                                            ...
                                            <button style="background-color: hsl(318, 99%, 70%); padding : 2px ; border-radius: 18px; color: #ffffff; text-align: center;" type="submit" class="btn btn-outline-success">Suivre</button>
                                            </form>
