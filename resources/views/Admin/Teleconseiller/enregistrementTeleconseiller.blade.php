   ...
   <main>
    <article class="container article">
        <article class=" article center ">
            ...
            <form action="{{route('postSaveTeleConseiller')}}" method="POST" style="background: #ffffff; border-radius: 11px; padding: 20px; margin-left: 43px; margin-right: 43px ; margin-top: 40px;">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  name="nom" placeholder="Nom du téléconseiller" required >
                    </div>
                    <div>
                        <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">prenons</label>
                        <input type="text" id="last_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="prenom" placeholder="Prénom du téléconseiller" required>
                    </div>
                    <div>
                        <label for="company" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Télephone</label>
                        <input type="text" id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  name="telephone" placeholder="N° de téléphone"  required  pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}">
                    </div>  
                    <div>
                        <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">email </label>
                        <input type="email" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="email" placeholder="Email du téléconseiller" required="">
                    </div>
				...
				<div class="order">
					...
					<table>
						...
						<tbody>
                            ...
                            <tr class="item{{$tele->id}}">
                                <td>{{$tele->nom}}</td>
                                <td>{{$tele->prenom}}</td>
                                <td>(+228) {{$tele->telephone}}</td>
                                <td>{{$tele->email}}</td>
                                <td>  
                                    <button  style="background-color: hsl(255, 77%, 26%); padding : 2px ; border-radius: 18px; color: #ffffff; text-align: center;" class="btn btn-outline-info edit-modal"
                                      data-id = "{{$tele->id}}"
                                      data-nom = "{{$tele->nom}}"
                                      data-prenom = "{{$tele->prenom}}"
                                      data-telephone = "{{$tele->telephone}}"
                                      data-email = "{{$tele->email}}"
                                      >Modifier
                                    </button>
                                </td>
                                <td>  
                                    <button  style="background-color: hsl(340, 85%, 54%); padding : 2px ; border-radius: 18px; color: #ffffff; text-align: center;" class="btn btn-outline-danger delete-modal"
                                      data-id = "{{$tele->id}}"
                                      data-nom = "{{$tele->nom}}"
                                      data-prenom = "{{$tele->prenom}}"
                                      >Désactiver
...
<script>
    ...
    $(".delete-modal").on("click", function (event) {
        ...
        $("#tele-nom").text($(this).data("nom"));
        $("#tele-prenom").text($(this).data("prenom"));
    ...
    $(".delete-tele").on("click", function () {
        ...
        $.ajax({
            type : "POST",
            url:"{{route('postDeleteTeleConseiller')}}",
            data:{
            ...
            error :function(data){
                $("#deleteModal").modal("hide");
                alert("Une erreur s'est produite, impossible de supprimer le téléconseiller");
            }
        });
    });
...
@section("body")
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Enrégistrement des téléconseillers</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <form class="form" action="{{route('postSaveTeleConseiller')}}" method="POST">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label">Nom </label>
                                                            <div class="col-sm-9">
                                                                <input class="form-control" style="text-transform: uppercase;" type="text" name="nom" placeholder="Nom du téléconseiller" required />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input class="form-control" style="text-transform: none;" type="text" name="prenom" placeholder="Prénom du téléconseiller" required />
                                                            </div>
                                                        </div>
                                                    </div>
													...
													<div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input class="form-control" style="" type="tel" name="telephone" placeholder="N° de téléphone" required />
                                                            </div>
                                                        </div>
                                                    </div>
													...
													<div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input class="form-control" style="text-transform: none;" type="email" name="email" placeholder="Email du téléconseiller" required />
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <div class="modal fade"  id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content" style="background-color: white;">
                <form class="form" action="{{route('postEditTeleConseiller')}}" method="POST">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Modifier les infos du téléconseiller</h5>
                        ...
                        <div class="row">
							...
							<div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="tel" name="telephone" class="form-control" id="edit-telephone" required />
                                    </div>
                                </div>
                            </div>
							<div class="col-sm-6">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-2" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="background-color: white;">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel-2">Désactiver un(e) téléconseiller(ère)</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p>Voulez-vous vraiment désactiver le compte de "<span><b id="tele-nom"></b></span> <span><b id="tele-prenom"></b></span>" ?</p>
                </div>
                <div class="modal-footer">
                    <input type="hidden" id="tele-id" />
                    <button type="button" class="btn btn-danger delete-tele">Désactiver</button>
