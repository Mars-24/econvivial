...
@section('title', 'Resultats auto test')
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" style="text-transform: none !important;">Resultats auto test</h4>
    ...
    <script>
        $(document).ready(function() {
            const dt = $('#dt').DataTable({
                ...
                deferRender: true,
                ajax: {
                    url: '{{ route("ajax.auto-test-result") }}',
                    type: 'post',
                    data: function (data) {
