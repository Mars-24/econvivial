  ...
  <header class="header" data-header>
   ...
   <main>
    <article class="container article">
      ...
      <p class="article-subtitle">Souscriptions au suivi de grossesse</p>
        ...
        <div class="card-wrapper">
          ...
          <div class="card task-card">
            ...
            <div>
              ...
              <p class="card-text">Total soucrits</p>
            </div>
...
<!-- 
			...
			<div class="table-data">
				<div class="order">
					<div class="head">
						<h3>Tables des  Souscriptions au suivi de grossesse</h3>
						<i class='bx bx-search' ></i>
						<i class='bx bx-filter' ></i>
						...
						<thead>
							<tr> 
                                <th>Date de souscription</th>
                                                    <th>Code</th>
                                                    <th>Nom	Semaine de grossesse</th>
                                                    <th>Robotcall</th>
                                                    <th>Détails suivi</th>
                                                    <th>Statut</th>
                                                    <th>Bloquer</th>
...
@section('title', 'Souscriptions au suivi de grossesse')
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 ">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" style="text-transform: none !important;">Souscriptions au suivi de grossesse</h4>
                                    ...
                                    <form id="send-sms" action="{{ route('postAlertDeSuiviDeOvulation') }}" method="POST" style="display: none;"></form>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            const dt = $('#dt').DataTable({
                ...
                ajax: {
                    url: '{{ route("ajax.suivis-grossesses") }}',
                    type: 'post',
                    data: function (data) {
                        for (var i = 0, len = data.columns.length; i < len; i++) {
                            ...
                            if (column === 'created_at' || column === 'dateRegle') {
                ...
                columns: [
                    ...
                    {
                        data: 'weeks',
                        title: 'Semaine de grossesse',
                        render: function(data, type, row, meta) {
                            return `${data} semaine(s)`;
                        },
                        orderable: false,
                        searchable: false,
                    },
                    ...
                    },
                    {
                        ...
                        title: 'Détails suivi',
                        render: function(data, type, row, meta) {
                            return data.weeks <= 14
                                ? `<label class="badge badge-success badge-pill">Grossesse en cours</label>`
                                : `<label class="badge badge-danger badge-pill">Grossesse à terme</label>`;
                        },
                    },
                    // {
                    //     data: 'weeks',
