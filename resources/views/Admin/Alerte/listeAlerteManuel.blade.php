  ...
  <header class="header" data-header>
   ...
   <main>
    <article class="container article">
      ...
      <p class="article-subtitle">Fiche de rapport manuel</p>
						...
						<tbody>
                            ...
                            <style>
                                ...
                                <tr class="item{{$rapport->id}}">
                                    ...
                                    <td>
                                        @if(!$rapport->terminer)
                                            <label style="background-color: hsl(356, 84%, 50%); padding : 2px ;"  class="badge badge-danger badge-pill">NON</label>
                                        @else
                                            <label  style="background-color: hsl(257, 79%, 20%); padding : 2px ;"  class="badge badge-success badge-pill">OUI</label>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
