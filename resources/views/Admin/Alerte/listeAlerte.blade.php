  ...
  <header class="header" data-header>
   ...
   <main>
    <article class="container article">
      ...
      <p class="article-subtitle">Fiche de rapport</p>
...
<!-- 
        ...
        <div class="card-wrapper">
          ...
          <div class="card task-card">
            ...
            <div>
              <data class="card-data" value="21"></data>
        ...
        <div class="card revenue-card">
          ...
          <li>
            ...
            <input type="date" style="background-color:none ; padding-bottom: 15px; margin-bottom: 15px ; " max="{{date('y-m-d')}}" value="{{$debut}}" type="date" name="debut">
          </li>
          <li>
            <span style="margin-left: 8px;">au</span>
            <input type="date" style="background-color:none ; border:1px solid dark; border-radius: 8px;"  max="{{date('Y-m-d') }}" value="{{ $fin }}" type="date" name="fin">
          </li>
...
<!-- 
			...
			<div class="table-data">
				<div class="order">
					<div class="head">
						<h3>Table des Fiches de rapport  </h3>
						<i class='bx bx-search' ></i>
					...
					<table>
						...
						<tbody>
                            ...
                            <tr class="item{{$rapport->id}}">
                                ...
                                <td>
                                    @if(!$rapport->terminer)
                                        <label style="background-color: hsl(356, 84%, 50%); padding : 2px ; border-radius: 18px;" class="badge badge-danger badge-pill">NON</label>
                                    @else
                                        <label style="background-color: hsl(257, 79%, 20%); padding : 2px ; border-radius: 18px;" class="badge badge-success badge-pill">OUI</label>
                                    @endif
                                </td>
                                <td>
                                    <form style="background-color: hsl(318, 99%, 70%); padding : 2px ; border-radius: 18px;"  action="{{route('detail-rapport-alerte-sms')}}" method="GET">
                        ...
                        @endforeach
                            ...
                            <tr class="item{{ $presence->id }}">
                                ...
                                @foreach($teleconseillers as $teleconseiller)
                                    @if($teleconseiller->id == $presence->teleconseiller_id)
                                        {{ $teleconseiller->nom }}
                                    @endif
                                @endforeach
                                </td>
                                ...
                                <td>
                                    <form action="{{route('gestion-presence-individuel-tele-conseiller') }}" method="GET">
                                        ...
                                        <button style="background-color: hsl(318, 99%, 70%); padding : 2px ; border-radius: 18px; color: #ffffff; text-align: center;" type="submit" class="btn btn-outline-success">Détail prestation</button>
                                    </form>
                                </td>
                            </tr>
                            @endforeach
