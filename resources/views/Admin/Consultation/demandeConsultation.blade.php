...
@section('title', 'Les demandes de consultations')
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 ">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" style="text-transform: none !important;">Les demandes de consultations</h4>
    ...
    <script>
        $(document).ready(function() {
            const dt = $('#dt').DataTable({
                ...
                ajax: {
                    url: '{{ route("ajax.demandes-consultations") }}',
                    type: 'post',
                    data: function (data) {
                ...
                columns: [
                    ...
                    // {
                    //     data: null,
                    //     title: 'Résultat de la consultation',
