                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <form class="form" action="{{route('postFormationSanitaire')}}"
                                                  method="POST">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label">Frais
                                                                consultation</label>
                                                            <div class="col-sm-9">
                                                                <input class="form-control" type="text" id="frais"
                                                                       name="frais" placeholder="Frais de consultation"
                                                                       required/>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" id="edit-frais" name="frais"
                                               placeholder="Frais de consultation" required/>
                                        <span class="msgFrais" style="color: red;"></span>
                                    </div>
                                </div>
                            </div>
