   ...
   <main>
    <article class="container article">
        <article class=" article center ">
            ...
            <form  action="{{route('saveUserTeleConseiller')}}" method="POST" style="background: #ffffff; border-radius: 11px; padding: 20px; margin-left: 43px; margin-right: 43px ; margin-top: 40px;">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="numero" id="edit-numero" placeholder="Le numéro de téléphone de l'utilisateur" >
                    </div>  
                    <div>
                        <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Profession Téléconseiller</label>
                    ...
                    <div>
                        <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Type de service </label>
                        <select name="service" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
...
<!-- 
			...
			<div class="table-data">
				<div class="order">
					<div class="head">
						<h3>Table de gestion des téleconseillers</h3>
						<i class='bx bx-search' ></i>
