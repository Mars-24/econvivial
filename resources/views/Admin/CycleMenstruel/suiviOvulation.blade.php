                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 ">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" style="text-transform: none !important;">Souscriptions au suivi d'ovulation</h4>
    ...
    <script>
        $(document).ready(function() {
            const dt = $('#dt').DataTable({
                ...
                ajax: {
                    url: '{{ route("ajax.suivis-ovulations") }}',
                    type: 'post',
                    data: function (data) {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        title: 'Date probable prochaines ovulation'
                    },
                    {
                        data: null,
                        title: 'Statut',
