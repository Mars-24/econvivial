                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">RAPPORT MENSUEL D’ACTIVITES DU SUPERVISEUR DU PAIR EDUCATEUR </h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            @endif
                                                ...
                                                <form action="{{route('generer-rapport-superviseur-universitaire')}}" method="POST">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <label class="col-form-label col-sm-3">{{$region->libelle}}</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-sm-3">Etablissement / Université :</label>
                                                            <div class="col-sm-9">
                                                                <label class="col-form-label col-sm-3">{{$universite->libelle}}</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-sm-3">Année :</label>
                                                            <div class="col-sm-9">
                                                                <label class="col-form-label col-sm-3">{{date("Y")}}</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-sm-3">Code superviseur :</label>
                                                            <div class="col-sm-9">
                                                                <label class="col-form-label col-sm-3">{{Auth::user()->paireducateur->code}}</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-sm-3">Nombre de rapport des PE compilés :</label>
                                                            <div class="col-sm-9">
                                                                <label class="col-form-label col-sm-3">{{count($rapports)}}</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-sm-3"> Nom et Prénoms du Superviseur :</label>
                                                            <div class="col-sm-9">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-sm-3">Population :</label>
                                                            <div class="col-sm-9">
                                                                <label class="col-form-label col-sm-3"><b>Etudiant</b></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
