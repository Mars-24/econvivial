                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">RAPPORT MENSUEL D’ACTIVITES DU M&E REGIONAL  {{Auth::user()->paireducateur->code}}</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            @endif
                                                ...
                                                <div class="row">
                                                    @if(count($rapports) > 0)
                                                        ...
                                                        <button type="button" id="exportExcel" onclick="exportTableToExcel('maTable', 'Historique rapport M&E Régionaux')" style="margin-left: 10px;margin-bottom: 20px;" class="btn btn-success">Exporter en excel</button>
                                                    @endif
                                                </div>
