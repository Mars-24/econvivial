                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Suivi du superviseur <span style="color: blue;">
                                            <b>{{$pair->nom }} {{$pair->prenom }}</b>
                                        </span></h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <table id="table" class="table table-bordered table-condensed table-striped table-responsive" cellspacing="0">
                                                ...
                                                @foreach($entretiens as $entretien)
                                                    <tr class="item{{$entretien->id}}">
                                                        ...
                                                        <td>
                                                            @if(!$entretien->supValidation)
                                                            <label class="badge badge-danger badge-pill">Attente</label>
                                                                @else
                                                                <label class="badge badge-success badge-pill">Valider</label>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                @endforeach
