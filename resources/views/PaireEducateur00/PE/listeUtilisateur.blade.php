                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Liste élèves / étudiant inscrit du <span style="color: blue;"><b>{{$ecole->libelle}}</b></span></h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                                ...
                                                @foreach($users as $user)
                                                    <tr class="item{{$user->id}}">
                                                        ...
                                                        <td>  <button class="btn btn-outline-info"
                                                                      ...
                                                                      data-ecole = "{{\App\PairEducateur::where('id', $user->pair_educateur_id)->first()->ecole->libelle}}"
                                                                      data-region = "{{\App\PairEducateur::where('id', $user->pair_educateur_id)->first()->region->libelle}}">Modifier</button></td>
