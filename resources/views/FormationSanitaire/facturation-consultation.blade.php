                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">ESPACE FACTURATION </h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <form action="" method="GET">
                                                <div class="row" style="margin-bottom: 30px;">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
                                                                <button type="submit" style="width: 250px;" class="btn btn-outline-success btn-rounded">Générer une facture</button>
                                                            </div>
                                                        </div>
                                                    </div>
										...
										@if($debut != null && $fin != null)
                                            ...
                                            <form action="save-facturation-consultation" method="POST">
                                        ...
                                        <div  class="col-sm-12" id="dataTable"  style="margin: 10px;" >
										 ...
										 <h4 class="card-title">NOM FORMATION SANATAIRE : <b style="color: blue;"> 
										 {{\App\FormationSanitaire::where("id", $utilisateur->formation_sanitaire_id)->first()->libelle}}</b></h4>
