                                ...
                                <div class="card-block-small">
                                    <a href="{{ route('conseil-pratique') }}">
                                        ...
                                        <div>
                                            <span class="f-left m-t-10 text-muted">
                                                <i class="text-c-blue f-16 icofont icofont-warning m-r-10"></i>
                                                Recevez les conseils pratiques des professionnels sur différentes
                                                thématiques. Nous vous fournissons des informations sur la santé ...
                                            </span>
                                        </div>
                                    </a>
                                </div>
                            ...
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    <a href="{{ route('do-consultation') }}">
                                        ...
                                        <div>
                                            <span class="f-left m-t-10 text-muted">
                                                <i class="text-c-pink f-16 icofont icofont-calendar m-r-10"></i>Le Centre
                                                Convivial vous offre des services adaptés en matière de la prise en charge
                                    ...
                                    <a href="{{ route('methode-naturelle') }}">
                                        ...
                                        <div>
                                            <span class="f-left m-t-10 text-muted">
                                                ...
                                                </i>Promouvoir l’espacement de naissance et éviter des grossesses précoces
                                                ou non désirées, tel est notre objectif. eCentre Convivial vous offre.
                                            </span>
                                        </div>
                                    </a>
                                </div>
                                        ...
                                        <a href="{{ route('suivi-de-grossesse') }}">
                                            ...
                                            <div>
                                                <span class="f-left m-t-10 text-muted">
                                                    ...
                                                    </i>Notre service organise le suivi de la grossesse, l’information et
                                                    l’accompagnement des futures mères et des futurs pères. Des sages-femmes
                                                    proposent ...
                                                </span>
                                            </div>
                                        </a>
                                ...
                                <div class="card-block-small">
                                    <a href="{{ route('suivi-de-regle') }}">
                                        ...
                                        <div>
                                            <span class="f-left m-t-10 text-muted">
                                                <i class="text-c-blue f-16 icofont icofont-warning m-r-10"></i>
                                                Nous assistons les femmes, surtout les jeunes filles scolaires et
                                                extrascolaires dans la gestion de leur cycle menstruel et l’hygiène ...
                                            </span>
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <a href="{{ route('assistance-medecin') }}">
                                        ...
                                        <div>
                                            <span class="f-left m-t-10 text-muted">
                                                ...
                                                Discuter 24h/24 et 7j/7 avec des professionnels de la santé (Médécin,
                                                Gynécologue, Sage-femme et conseillers) pour tous vos problèmes de
                                                sexualité.
                                            </span>
                                        </div>
                                    </a>
                                ...
                                <a href="">
                                    <div class="card-block-small">
                                        <a href="{{ route('user-dashboard-quiz') }}">
                                            ...
                                            <div>
                                                <span class="f-left m-t-10 text-muted">
                                                    <i class="text-c-green f-16 icofont icofont-tag m-r-10"></i>eCentre
                                                    Convivial vous propose des jeux Puzzle et des questions Quizz pouvant
                                                    voous permettre de gagner des prix.
                                                </span>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <a href="#">
                                        ...
                                        <div>
                                            <span class="f-left m-t-10 text-muted">
                                                ...
                                                Soyez informés de tous les événements dans votre pays, en Afrique ou dans le
                                                monde en lien avec la santé sexuelle et de la reproduction ou connexe.
                                            </span>
                                        </div>
                                    </a>
                                </div>
                        ...
                        <div class="card" style="width: 100%;">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs tab-solid tab-solid-danger" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="tab-5-2" data-toggle="tab" href="#profile-5-2"
                                            role="tab" aria-controls="profile-5-2" aria-selected="false">Videos</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" id="tab-5-1" data-toggle="tab" href="#home-5-1"
                                            role="tab" aria-controls="home-5-1" aria-selected="true">Gallery</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" id="tab-5-3" data-toggle="tab" href="#contact-5-3"
                                            role="tab" aria-controls="contact-5-3"
                                            aria-selected="false">Activités</a>
                                    </li>
                                </ul>

                                <div class="tab-content tab-content-solid"
                                    style="border: rgba(0,0,0,0.4) 1px solid;padding: 10px;">
                                    <div class="tab-pane fade show active" id="profile-5-2" role="tabpanel"
                                        aria-labelledby="tab-5-2">
                                        <div id="video-gallery" class="row lightGallery">
                                            @foreach ($videos as $video)
                                                <a class="image-tile col-xl-3 col-lg-3 col-md-3 col-md-4 col-6"
                                                    target="_blank"
                                                    href="https://www.youtube.com/watch?v={{ $video->url }}">
                                                    <img class="img img-responsive" src="{{ $video->image }}" />
                                    ...
                                    <div class="tab-pane fade show " id="home-5-1" role="tabpanel"
                                        aria-labelledby="tab-5-1">
                                        <div class="row grid-margin">
                                            <div class="col-lg-12">
                                                <div class="card px-3">
                                                    <div id="lightgallery-without-thumb" class="row lightGallery">
                                                        <a href="images/gallery/img1.jpg" target="_blank"
                                                            class="image-tile" alt="image large"><img
                                                                src="images/gallery/img1.jpg" alt="Aucune image"></a>
                                                        <a href="images/gallery/img2.jpg" target="_blank"
                                                            class="image-tile" alt="image large"><img
                                                                src="images/gallery/img2.jpg" alt="Aucune image"></a>
                                                        <a href="images/gallery/img3.jpg.jpg" target="_blank"
                                                            class="image-tile" alt="image large"><img
                                                                src="images/gallery/img3.jpg" alt="Aucune image"></a>
                                                        <a href="images/gallery/img4.jpg" target="_blank"
                                                            class="image-tile" alt="image large"><img
                                                                src="images/gallery/img4.jpg" alt="Aucune image"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="contact-5-3" role="tabpanel"
                                        ...
                                        novatrices de l’application, l’acquisition des compétences de vie pour leur avenir,
                                        le
                                        changement de comportement, des services offerts et la référence vers des centres
                                        conviviaux
